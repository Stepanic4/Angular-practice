...
export class LayoutService {
   ...
   */
  public onBodyClick: Subject<MouseEvent> = new Subject<MouseEvent>();
  ...
  constructor() {
    ...
    fromEvent<MouseEvent>(document.body, 'click').subscribe((event: MouseEvent): void => this.onBodyClick.next(event));
